...
ann_file_train = f'{anno_root}/trauma_train_V2.csv'
ann_file_val = f'{anno_root}/trauma_val_V2.csv'
...
proposal_file_train = (f'{anno_root}/trauma_train_V2.csv.pkl')
proposal_file_val = f'{anno_root}/trauma_val_V2.csv.pkl'
