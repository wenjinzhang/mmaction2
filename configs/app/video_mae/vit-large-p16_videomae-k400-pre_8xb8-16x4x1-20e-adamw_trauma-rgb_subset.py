...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=104, val_begin=1, val_interval=1)
...
default_hooks = dict(checkpoint=dict(max_keep_ckpts=2), visualization=dict(type='VisualizationHook'))
