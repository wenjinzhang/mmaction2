...
nohup bash tools/dist_train.sh configs/app/slowfast/slowfast_kinetics400-pretrained-r50_8xb8-8x8x1-20e_trauma-rgb.py \
    2 --seed 0 > log/train_r50_8xb8-8x8x1-20e_trauma.txt 2>&1 &
...
python tools/test.py configs/app/slowfast/slowfast_kinetics400-pretrained-r50_8xb8-8x8x1-20e_trauma-rgb.py \
    work_dirs/slowfast_kinetics400-pretrained-r50_8xb8-8x8x1-20e_trauma-rgb/epoch_20.pth --dump log/result.pkl
