...
ann_file_train = 'data/trauma/annotations/trauma_trainV2.csv'
ann_file_val = 'data/trauma/annotations/trauma_valV2.csv'
...
proposal_file_train = 'data/trauma/annotations/trauma_valV2.csv.pkl'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='AVADataset',
        ann_file='data/trauma/annotations/trauma_trainV2.csv',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='AVADataset',
        ann_file='data/trauma/annotations/trauma_valV2.csv',
...
launcher = 'pytorch'
work_dir = './work_dirs/vit-large-p16_videomae-k400-pre_8xb8-16x4x1-20e-adamw_trauma-rgb_subset'
